...
<ul>
<li>姓名:Mr.Xu</li>
<li>电话:18471795707</li>
<li>邮箱:jiansheng_xu@163.com</li>
<li>求职意向:Java开发工程师</li>
<li>工作经验：1年</li>
<li>Github（可选）:<a href="https://github.com/jiansheng_xu" target="_blank" rel="noopener noreferrer">https://github.com/jiansheng_xu<ExternalLinkIcon/></a></li>
<li>个人网站（可选）:<a href="https://www.snailcoding.cn/" target="_blank" rel="noopener noreferrer">https://www.snailcoding.cn/<ExternalLinkIcon/></a></li>
</ul>
<h2 id="教育背景" tabindex="-1"><a class="header-anchor" href="#教育背景"><span>教育背景</span></a></h2>
<ul>
<li>毕业时间：2019年9月～2023年7月</li>
<li>毕业院校：XX大学 软件工程专业</li>
<li>学历：本科</li>
</ul>
...
<li>深入学习 Spring 核心流程模块，如IOC、AOP、依赖倒置等，掌握Spring解决复杂场景所需的分治、抽象和知识（设计模式、设计原则），能从核心原理上解决Spring场景问题。同时，具备基于 Spring 开发 SpringBoot Starter 的技能，减少研发成本，为复杂项目提供通用技术组件。</li>
<li>深入学习 MyBatis 核心流程模块，包括会话、反射、代理、事务和插件，熟练掌握 ORM 框架的设计思想、实现方式和应用价值。并根据需求结合 MyBatis 插件机制，开发企业所需的功能，如数据分页、数据库表路由、监控日志和数据安全等。</li>
<li>熟练掌握 Spring Cloud 微服务架构设计，包括服务注册与发现、服务降级、限流、熔断、服务网关</li>
<li>深入理解 Spring Boot，Spring Cloud 等微服务框架的设计原理及底层架构，熟悉各种微服务架构设计比如服务注册与发现，服务降级，限流，熔断，服务网关路由设计，服务安全认证架构。</li>
<li>熟悉Dubbo、Zookeeper 等分布式服务协调与治理等技术。</li>
<li>熟练掌握MySql，掌握 MySQL 主从同步，读写分离技术以及集群的搭建，具备一定的 SQL 调优能力。</li>
...
<li>熟练掌握 JavaSE 基础知识，熟悉多线程与并发编程，具备良好的面向对象编程思想。</li>
<li>熟练掌握 Java 设计模式，如工厂、代理、模板、策略等设计模式，并善用设计原则构建可复用代码。</li>
<li>深入理解 JVM 底层原理，熟悉 JVM 各类垃圾收集器的使用及核心参数的调优，具备一定的 JVM 调优能力。</li>
<li>熟练使用 Spring、SpringMVC、SpringBoot、MyBatis 等开源框架，多年实战经验，可快速根据需求完成项目的构建；阅读并编写过 Spring 全链路核心功能源码，如 AOP、IOC，对源码有一定的理解，并能运用到实际业务开发中。</li>
<li>熟练运用 Spring Cloud/Spring Cloud Alibaba 技术栈，以及基于微服务框架搭建和开发，对分布式服务特点，旧服务的改造，服务划分有着深入理解。</li>
<li>熟练使用 MySQL数据库，熟悉数据库事务控制、索引优化、SQL 语句调优。</li>
<li>熟练掌握 Redis 的核心数据结构的使用场景，熟悉各种缓存高并发的使用场景，比如缓存雪崩，缓存穿透</li>
<li>掌握 Linux 常用命令，了解 Nginx 服务器,熟练使用其实现反向代理,负载均衡,动静分离等功能。</li>
<li>熟悉 docker 常用命令，使用docker运维项目，有过线上排查问题的经验</li>
</ul>
<h2 id="工作经历" tabindex="-1"><a class="header-anchor" href="#工作经历"><span>工作经历</span></a></h2>
<ul>
<li>公司：深圳市宇航智能信息技术有限公司</li>
<li>岗位：Java开发工程师</li>
<li>时间：2023.3~2024.3</li>
<li>职责（可选）：
<ul>
<li>对生产数据中的核心数据表进行分析，结果显示表中 85%的数据为冷数据，对此对表进行了冷热数据的拆分，使得核心表的数据保持在 300 万左右，使得核心表的读写效率提高了 90%</li>
<li>对扫描逻辑的代码流程重构，引入 Redis，将生产扫描的数据进行预热处理，引入了 Redisson 分布式锁，防止产品码同一时间的重复扫描。</li>
<li>引入 SkyWalking 对分布式链路进行监控和追踪。</li>
</ul>
</li>
<li>成绩【可选】</li>
</ul>
...
<h3 id="_5-华大智造mes项目" tabindex="-1"><a class="header-anchor" href="#_5-华大智造mes项目"><span>5. 华大智造MES项目</span></a></h3>
<ul>
<li>项目名称：华大智造MES项目</li>
<li>项目描述：本项目为华大智造专项定制好研发的医疗行业的MES系统，解决医疗行业全生产流程的信息化管理，打破了和供应商之间的生产信息壁垒，全库存信息、供方制造过程全透明、过程批次扣料绑定追溯、作业标准化，供方品质在线</li>
<li>技术架构：Spring Boot、Spring Cloud、MyBatis、RabbitMQ、MyBatis-Plus、MySQL、Redis、xxl-job、Vue、Echarts</li>
<li>职责描述：
<ul>
<li>基于公司已有的MES系统基础，进行专项化业务定制、需求升级</li>
<li>在客户公司，深入生产部门与负责人对接需求，详细梳理业务流程，确保最终业务需求绝对清晰</li>
<li>配合产品经理，详细梳理业务流程，产出原型以及需求文档，并于甲方老师确认</li>
<li>主要负责：生产执行、工单管理这两个业务板块下的接口设计与开发</li>
<li>配合产品经理，详细梳理业务流程，产出原型以及需求文档，并于甲方老师确认</li>
<li>在客户公司，深入生产部门与负责人对接需求，详细梳理业务流程，确保最终业务需求绝对清晰</li>
</ul>
</li>
