...
<h2 id="什么是数据库-数据库管理系统-数据库系统-数据库管理员" tabindex="-1"><a class="header-anchor" href="#什么是数据库-数据库管理系统-数据库系统-数据库管理员"><span>什么是数据库, 数据库管理系统, 数据库系统, 数据库管理员?</span></a></h2>
<ul>
...
<h2 id="什么是元组-码-候选码-主码-外码-主属性-非主属性" tabindex="-1"><a class="header-anchor" href="#什么是元组-码-候选码-主码-外码-主属性-非主属性"><span>什么是元组, 码, 候选码, 主码, 外码, 主属性, 非主属性？</span></a></h2>
<ul>
...
<h2 id="什么是-er-图" tabindex="-1"><a class="header-anchor" href="#什么是-er-图"><span>什么是 ER 图？</span></a></h2>
...
<h2 id="数据库范式了解吗" tabindex="-1"><a class="header-anchor" href="#数据库范式了解吗"><span>数据库范式了解吗?</span></a></h2>
<p>数据库范式有 3 种：</p>
<ul>
...
<h3 id="_1nf-第一范式" tabindex="-1"><a class="header-anchor" href="#_1nf-第一范式"><span>1NF(第一范式)</span></a></h3>
<p>属性（对应于表中的字段）不能再被分割，也就是这个字段只能是一个值，不能再分为多个其他的字段了。<strong>1NF 是所有关系型数据库的最基本要求</strong> ，也就是说关系型数据库中创建的表一定满足第一范式。</p>
<h3 id="_2nf-第二范式" tabindex="-1"><a class="header-anchor" href="#_2nf-第二范式"><span>2NF(第二范式)</span></a></h3>
...
<h3 id="_3nf-第三范式" tabindex="-1"><a class="header-anchor" href="#_3nf-第三范式"><span>3NF(第三范式)</span></a></h3>
...
<h2 id="主键和外键有什么区别" tabindex="-1"><a class="header-anchor" href="#主键和外键有什么区别"><span>主键和外键有什么区别?</span></a></h2>
<ul>
...
<h2 id="为什么不推荐使用外键与级联" tabindex="-1"><a class="header-anchor" href="#为什么不推荐使用外键与级联"><span>为什么不推荐使用外键与级联？</span></a></h2>
...
<h2 id="什么是存储过程" tabindex="-1"><a class="header-anchor" href="#什么是存储过程"><span>什么是存储过程?</span></a></h2>
...
<h2 id="drop、delete-与-truncate-区别" tabindex="-1"><a class="header-anchor" href="#drop、delete-与-truncate-区别"><span>drop、delete 与 truncate 区别？</span></a></h2>
<h3 id="用法不同" tabindex="-1"><a class="header-anchor" href="#用法不同"><span>用法不同</span></a></h3>
<ul>
...
<p><code v-pre>truncate</code> 和不带 <code v-pre>where</code>子句的 <code v-pre>delete</code>、以及 <code v-pre>drop</code> 都会删除表内的数据，但是 <strong><code v-pre>truncate</code> 和 <code v-pre>delete</code> 只删除数据不删除表的结构(定义)，执行 <code v-pre>drop</code> 语句，此表的结构也会删除，也就是执行<code v-pre>drop</code> 之后对应的表不复存在。</strong></p>
<h3 id="属于不同的数据库语言" tabindex="-1"><a class="header-anchor" href="#属于不同的数据库语言"><span>属于不同的数据库语言</span></a></h3>
<p><code v-pre>truncate</code> 和 <code v-pre>drop</code> 属于 DDL(数据定义语言)语句，操作立即生效，原数据不放到 rollback segment 中，不能回滚，操作不触发 trigger。而 <code v-pre>delete</code> 语句是 DML (数据库操作语言)语句，这个操作会放到 rollback segment 中，事务提交之后才生效。</p>
...
<p>另外，由于<code v-pre>select</code>不会对表进行破坏，所以有的地方也会把<code v-pre>select</code>单独区分开叫做数据库查询语言 DQL（Data Query Language）。</p>
<h3 id="执行速度不同" tabindex="-1"><a class="header-anchor" href="#执行速度不同"><span>执行速度不同</span></a></h3>
<p>一般来说：<code v-pre>drop</code> &gt; <code v-pre>truncate</code> &gt; <code v-pre>delete</code>（这个我没有实际测试过）。</p>
<ul>
<li><code v-pre>delete</code>命令执行的时候会产生数据库的<code v-pre>binlog</code>日志，而日志记录是需要消耗时间的，但是也有个好处方便数据回滚恢复。</li>
<li><code v-pre>truncate</code>命令执行的时候不会产生数据库日志，因此比<code v-pre>delete</code>要快。除此之外，还会把表的自增值重置和索引恢复到初始大小等。</li>
<li><code v-pre>drop</code>命令会把表占用的空间全部释放掉。</li>
</ul>
<p>Tips：你应该更多地关注在使用场景上，而不是执行效率。</p>
<h2 id="数据库设计通常分为哪几步" tabindex="-1"><a class="header-anchor" href="#数据库设计通常分为哪几步"><span>数据库设计通常分为哪几步?</span></a></h2>
<ol>
