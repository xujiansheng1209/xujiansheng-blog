...
<p>如果使用 <strong><code v-pre>utf8</code></strong> 的话，存储 emoji 符号和一些比较复杂的汉字、繁体字就会出错。</p>
<p>为什么会这样呢？这篇文章可以从源头给你解答。</p>
<h2 id="字符集是什么" tabindex="-1"><a class="header-anchor" href="#字符集是什么"><span>字符集是什么？</span></a></h2>
...
<h2 id="字符编码是什么" tabindex="-1"><a class="header-anchor" href="#字符编码是什么"><span>字符编码是什么？</span></a></h2>
...
<h2 id="有哪些常见的字符集" tabindex="-1"><a class="header-anchor" href="#有哪些常见的字符集"><span>有哪些常见的字符集？</span></a></h2>
...
<h3 id="ascii" tabindex="-1"><a class="header-anchor" href="#ascii"><span>ASCII</span></a></h3>
...
<h3 id="gb2312" tabindex="-1"><a class="header-anchor" href="#gb2312"><span>GB2312</span></a></h3>
...
<h3 id="gb18030" tabindex="-1"><a class="header-anchor" href="#gb18030"><span>GB18030</span></a></h3>
<p>GB18030 完全兼容 GB2312 和 GBK 字符集，纳入中国国内少数民族的文字，且收录了日韩汉字，是目前为止最全面的汉字字符集，共收录汉字 70000 多个。</p>
<h3 id="big5" tabindex="-1"><a class="header-anchor" href="#big5"><span>BIG5</span></a></h3>
<p>BIG5 主要针对的是繁体中文，收录了 13000 多个汉字。</p>
<h3 id="unicode-utf-8" tabindex="-1"><a class="header-anchor" href="#unicode-utf-8"><span>Unicode &amp; UTF-8</span></a></h3>
...
<h2 id="mysql-字符集" tabindex="-1"><a class="header-anchor" href="#mysql-字符集"><span>MySQL 字符集</span></a></h2>
<p>MySQL 支持很多种字符集的方式，比如 GB2312、GBK、BIG5、多种 Unicode 字符集（UTF-8 编码、UTF-16 编码、UCS-2 编码、UTF-32 编码等等）。</p>
<h3 id="查看支持的字符集" tabindex="-1"><a class="header-anchor" href="#查看支持的字符集"><span>查看支持的字符集</span></a></h3>
<p>你可以通过 <code v-pre>SHOW CHARSET</code> 命令来查看，支持 like 和 where 子句。</p>
<figure><img src="https://oss.javaguide.cn/javaguide/image-20211008164229671.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<h3 id="默认字符集" tabindex="-1"><a class="header-anchor" href="#默认字符集"><span>默认字符集</span></a></h3>
<p>在 MySQL5.7 中，默认字符集是 <code v-pre>latin1</code> ；在 MySQL8.0 中，默认字符集是 <code v-pre>utf8mb4</code></p>
<h3 id="字符集的层次级别" tabindex="-1"><a class="header-anchor" href="#字符集的层次级别"><span>字符集的层次级别</span></a></h3>
<p>MySQL 中的字符集有以下的层次级别：</p>
<ul>
<li><code v-pre>server</code>（MySQL 实例级别）</li>
<li><code v-pre>database</code>（库级别）</li>
<li><code v-pre>table</code>（表级别）</li>
<li><code v-pre>column</code>（字段级别）</li>
</ul>
<p>它们的优先级可以简单的认为是从上往下依次增大，也即 <code v-pre>column</code> 的优先级会大于 <code v-pre>table</code> 等其余层次的。如指定 MySQL 实例级别字符集是<code v-pre>utf8mb4</code>，指定某个表字符集是<code v-pre>latin1</code>，那么这个表的所有字段如果不指定的话，编码就是<code v-pre>latin1</code>。</p>
<h4 id="server" tabindex="-1"><a class="header-anchor" href="#server"><span>server</span></a></h4>
<p>不同版本的 MySQL 其 <code v-pre>server</code> 级别的字符集默认值不同，在 MySQL5.7 中，其默认值是 <code v-pre>latin1</code> ；在 MySQL8.0 中，其默认值是 <code v-pre>utf8mb4</code> 。</p>
<p>当然也可以通过在启动 <code v-pre>mysqld</code> 时指定 <code v-pre>--character-set-server</code> 来设置 <code v-pre>server</code> 级别的字符集。</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code>mysqld
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>或者如果你是通过源码构建的方式启动的 MySQL，你可以在 <code v-pre>cmake</code> 命令中指定选项：</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code>cmake <span class="token builtin class-name">.</span> <span class="token parameter variable">-DDEFAULT_CHARSET</span><span class="token operator">=</span>latin1
或者
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此外，你也可以在运行时改变 <code v-pre>character_set_server</code> 的值，从而达到修改 <code v-pre>server</code> 级别的字符集的目的。</p>
<p><code v-pre>server</code> 级别的字符集是 MySQL 服务器的全局设置，它不仅会作为创建或修改数据库时的默认字符集（如果没有指定其他字符集），还会影响到客户端和服务器之间的连接字符集，具体可以查看 <a href="https://dev.mysql.com/doc/connector-j/8.0/en/connector-j-reference-charsets.html" target="_blank" rel="noopener noreferrer">MySQL Connector/J 8.0 - 6.7 Using Character Sets and Unicode<ExternalLinkIcon/></a>。</p>
<h4 id="database" tabindex="-1"><a class="header-anchor" href="#database"><span>database</span></a></h4>
<p><code v-pre>database</code> 级别的字符集是我们在创建数据库和修改数据库时指定的：</p>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">DATABASE</span> db_name
...
<span class="token keyword">ALTER</span> <span class="token keyword">DATABASE</span> db_name
    <span class="token punctuation">[</span><span class="token punctuation">[</span><span class="token keyword">DEFAULT</span><span class="token punctuation">]</span> <span class="token keyword">CHARACTER</span> <span class="token keyword">SET</span> charset_name<span class="token punctuation">]</span>
    <span class="token punctuation">[</span><span class="token punctuation">[</span><span class="token keyword">DEFAULT</span><span class="token punctuation">]</span> <span class="token keyword">COLLATE</span> collation_name<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如前面所说，如果在执行上述语句时未指定字符集，那么 MySQL 将会使用 <code v-pre>server</code> 级别的字符集。</p>
<p>可以通过下面的方式查看某个数据库的字符集：</p>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">USE</span> db_name<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">SELECT</span> DEFAULT_CHARACTER_SET_NAME<span class="token punctuation">,</span> DEFAULT_COLLATION_NAME
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="table" tabindex="-1"><a class="header-anchor" href="#table"><span>table</span></a></h4>
<p><code v-pre>table</code> 级别的字符集是在创建表和修改表时指定的：</p>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> tbl_name <span class="token punctuation">(</span>column_list<span class="token punctuation">)</span>
    <span class="token punctuation">[</span><span class="token punctuation">[</span><span class="token keyword">DEFAULT</span><span class="token punctuation">]</span> <span class="token keyword">CHARACTER</span> <span class="token keyword">SET</span> charset_name<span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果在创建表和修改表时未指定字符集，那么将会使用 <code v-pre>database</code> 级别的字符集。</p>
<h4 id="column" tabindex="-1"><a class="header-anchor" href="#column"><span>column</span></a></h4>
<p><code v-pre>column</code> 级别的字符集同样是在创建表和修改表时指定的，只不过它是定义在列中。下面是个例子：</p>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> t1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果未指定列级别的字符集，那么将会使用表级别的字符集。</p>
<h3 id="连接字符集" tabindex="-1"><a class="header-anchor" href="#连接字符集"><span>连接字符集</span></a></h3>
<p>前面说到了字符集的层次级别，它们是和存储相关的。而连接字符集涉及的是和 MySQL 服务器的通信。</p>
<p>连接字符集与下面这几个变量息息相关：</p>
<ul>
<li><code v-pre>character_set_client</code> ：描述了客户端发送给服务器的 SQL 语句使用的是什么字符集。</li>
<li><code v-pre>character_set_connection</code> ：描述了服务器接收到 SQL 语句时使用什么字符集进行翻译。</li>
<li><code v-pre>character_set_results</code> ：描述了服务器返回给客户端的结果使用的是什么字符集。</li>
</ul>
<p>它们的值可以通过下面的 SQL 语句查询：</p>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">SELECT</span> <span class="token operator">*</span> <span class="token keyword">FROM</span> performance_schema<span class="token punctuation">.</span>session_variables
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">SHOW</span> <span class="token keyword">SESSION</span> VARIABLES <span class="token operator">LIKE</span> <span class="token string">'character\_set\_%'</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果要想修改前面提到的几个变量的值，有以下方式：</p>
<p>1、修改配置文件</p>
<div class="language-properties line-numbers-mode" data-ext="properties" data-title="properties"><pre v-pre class="language-properties"><code>[mysql]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、使用 SQL 语句</p>
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">set</span> names utf8mb4
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="jdbc-对连接字符集的影响" tabindex="-1"><a class="header-anchor" href="#jdbc-对连接字符集的影响"><span>JDBC 对连接字符集的影响</span></a></h3>
...
<p><code v-pre>mysql-connector-java</code> （JDBC 驱动）主要通过这几个属性影响连接字符集：</p>
<ul>
<li><code v-pre>characterEncoding</code></li>
<li><code v-pre>characterSetResults</code></li>
</ul>
<p>以 <code v-pre>DataGrip 2023.1.2</code> 来说，在它配置数据源的高级对话框中，可以看到 <code v-pre>characterSetResults</code> 的默认值是 <code v-pre>utf8</code> ，在使用 <code v-pre>mysql-connector-java 8.0.25</code> 时，连接字符集最后会被设置成 <code v-pre>utf8mb3</code> 。那么这种情况下 emoji 表情就会被显示为问号，并且当前版本驱动还不支持把 <code v-pre>characterSetResults</code> 设置为 <code v-pre>utf8mb4</code> ，不过换成 <code v-pre>mysql-connector-java driver 8.0.29</code> 却是允许的。</p>
<p>具体可以看一下 StackOverflow 的 <a href="https://stackoverflow.com/questions/54815419/datagrip-mysql-stores-emojis-correctly-but-displays-them-as" target="_blank" rel="noopener noreferrer">DataGrip MySQL stores emojis correctly but displays them as?<ExternalLinkIcon/></a>这个回答。</p>
<h3 id="utf-8-使用" tabindex="-1"><a class="header-anchor" href="#utf-8-使用"><span>UTF-8 使用</span></a></h3>
...
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> <span class="token identifier"><span class="token punctuation">`</span>user<span class="token punctuation">`</span></span> <span class="token punctuation">(</span>
...
<div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre v-pre class="language-sql"><code><span class="token keyword">INSERT</span> <span class="token keyword">INTO</span> <span class="token identifier"><span class="token punctuation">`</span>user<span class="token punctuation">`</span></span> <span class="token punctuation">(</span><span class="token identifier"><span class="token punctuation">`</span>id<span class="token punctuation">`</span></span><span class="token punctuation">,</span> <span class="token identifier"><span class="token punctuation">`</span>name<span class="token punctuation">`</span></span><span class="token punctuation">,</span> <span class="token identifier"><span class="token punctuation">`</span>phone<span class="token punctuation">`</span></span><span class="token punctuation">,</span> <span class="token identifier"><span class="token punctuation">`</span>password<span class="token punctuation">`</span></span><span class="token punctuation">)</span>
...
<div class="language-plain line-numbers-mode" data-ext="plain" data-title="plain"><pre v-pre class="language-plain"><code>Incorrect string value: '\xF0\x9F\x98\x98\xF0\x9F...' for column 'name' at row 1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考"><span>参考</span></a></h2>
<ul>
...
<li>MySQL8 文档：<a href="https://dev.mysql.com/doc/refman/8.0/en/charset.html" target="_blank" rel="noopener noreferrer">https://dev.mysql.com/doc/refman/8.0/en/charset.html<ExternalLinkIcon/></a></li>
<li>MySQL5.7 文档：<a href="https://dev.mysql.com/doc/refman/5.7/en/charset.html" target="_blank" rel="noopener noreferrer">https://dev.mysql.com/doc/refman/5.7/en/charset.html<ExternalLinkIcon/></a></li>
<li>MySQL Connector/J 文档：<a href="https://dev.mysql.com/doc/connector-j/8.0/en/connector-j-reference-charsets.html" target="_blank" rel="noopener noreferrer">https://dev.mysql.com/doc/connector-j/8.0/en/connector-j-reference-charsets.html<ExternalLinkIcon/></a></li>
</ul>
</div></template>
