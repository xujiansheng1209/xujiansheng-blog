<template><div><h2 id="nosql-是什么" tabindex="-1"><a class="header-anchor" href="#nosql-是什么"><span>NoSQL 是什么？</span></a></h2>
...
<h2 id="sql-和-nosql-有什么区别" tabindex="-1"><a class="header-anchor" href="#sql-和-nosql-有什么区别"><span>SQL 和 NoSQL 有什么区别？</span></a></h2>
<table>
<thead>
<tr>
...
<h2 id="nosql-数据库有什么优势" tabindex="-1"><a class="header-anchor" href="#nosql-数据库有什么优势"><span>NoSQL 数据库有什么优势？</span></a></h2>
...
<h2 id="nosql-数据库有哪些类型" tabindex="-1"><a class="header-anchor" href="#nosql-数据库有哪些类型"><span>NoSQL 数据库有哪些类型？</span></a></h2>
...
<p>下面这张图片来源于 <a href="https://learn.microsoft.com/en-us/dotnet/architecture/cloud-native/relational-vs-nosql-data" target="_blank" rel="noopener noreferrer">微软的官方文档 | 关系数据与 NoSQL 数据<ExternalLinkIcon/></a>。</p>
...
<ul>
<li>NoSQL 是什么？- MongoDB 官方文档：<a href="https://www.mongodb.com/zh-cn/nosql-explained" target="_blank" rel="noopener noreferrer">https://www.mongodb.com/zh-cn/nosql-explained<ExternalLinkIcon/></a></li>
<li>什么是 NoSQL? - AWS：<a href="https://aws.amazon.com/cn/nosql/" target="_blank" rel="noopener noreferrer">https://aws.amazon.com/cn/nosql/<ExternalLinkIcon/></a></li>
<li>NoSQL vs. SQL Databases - MongoDB 官方文档：<a href="https://www.mongodb.com/zh-cn/nosql-explained/nosql-vs-sql" target="_blank" rel="noopener noreferrer">https://www.mongodb.com/zh-cn/nosql-explained/nosql-vs-sql<ExternalLinkIcon/></a></li>
</ul>
</div></template>
