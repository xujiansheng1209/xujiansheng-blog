<template><div><h2 id="jdk-命令行工具" tabindex="-1"><a class="header-anchor" href="#jdk-命令行工具"><span>JDK 命令行工具</span></a></h2>
...
<h3 id="jps-查看所有-java-进程" tabindex="-1"><a class="header-anchor" href="#jps-查看所有-java-进程"><span><code v-pre>jps</code>:查看所有 Java 进程</span></a></h3>
...
<div class="language-powershell line-numbers-mode" data-ext="powershell" data-title="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jps
7360 NettyClient2
17396
7972 Launcher
16504 Jps
...
<div class="language-powershell line-numbers-mode" data-ext="powershell" data-title="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jps <span class="token operator">-</span>l
...
<h3 id="jstat-监视虚拟机各种运行状态信息" tabindex="-1"><a class="header-anchor" href="#jstat-监视虚拟机各种运行状态信息"><span><code v-pre>jstat</code>: 监视虚拟机各种运行状态信息</span></a></h3>
...
<li><code v-pre>jstat -gcold vmid</code>：显示老年代和永久代的行为统计，从 jdk1.8 开始,该选项仅表示老年代，因为永久代被移除了；</li>
<li><code v-pre>jstat -gcoldcapacity vmid</code>：显示老年代的大小；</li>
<li><code v-pre>jstat -gcpermcapacity vmid</code>：显示永久代大小，从 jdk1.8 开始,该选项不存在了，因为永久代被移除了；</li>
<li><code v-pre>jstat -gcutil vmid</code>：显示垃圾收集信息；</li>
</ul>
<p>另外，加上 <code v-pre>-t</code>参数可以在输出信息上加一个 Timestamp 列，显示程序的运行时间。</p>
<h3 id="jinfo-实时地查看和调整虚拟机各项参数" tabindex="-1"><a class="header-anchor" href="#jinfo-实时地查看和调整虚拟机各项参数"><span><code v-pre>jinfo</code>: 实时地查看和调整虚拟机各项参数</span></a></h3>
...
<div class="language-powershell line-numbers-mode" data-ext="powershell" data-title="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jinfo  <span class="token operator">-</span>flag MaxHeapSize 17340
...
<div class="language-powershell line-numbers-mode" data-ext="powershell" data-title="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jinfo  <span class="token operator">-</span>flag  PrintGC 17340
<span class="token operator">-</span>XX:<span class="token operator">-</span>PrintGC
...
C:\Users\SnailClimb>jinfo  <span class="token operator">-</span>flag  PrintGC 17340
<span class="token operator">-</span>XX:<span class="token operator">+</span>PrintGC
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="jmap-生成堆转储快照" tabindex="-1"><a class="header-anchor" href="#jmap-生成堆转储快照"><span><code v-pre>jmap</code>:生成堆转储快照</span></a></h3>
...
<div class="language-powershell line-numbers-mode" data-ext="powershell" data-title="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jmap <span class="token operator">-</span>dump:format=b<span class="token punctuation">,</span>file=C:\Users\SnailClimb\Desktop\heap<span class="token punctuation">.</span>hprof 17340
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="jhat-分析-heapdump-文件" tabindex="-1"><a class="header-anchor" href="#jhat-分析-heapdump-文件"><span><strong><code v-pre>jhat</code></strong>: 分析 heapdump 文件</span></a></h3>
<p><strong><code v-pre>jhat</code></strong> 用于分析 heapdump 文件，它会建立一个 HTTP/HTML 服务器，让用户可以在浏览器上查看分析结果。</p>
<div class="language-powershell line-numbers-mode" data-ext="powershell" data-title="powershell"><pre v-pre class="language-powershell"><code>C:\Users\SnailClimb>jhat C:\Users\SnailClimb\Desktop\heap<span class="token punctuation">.</span>hprof
...
<h3 id="jstack-生成虚拟机当前时刻的线程快照" tabindex="-1"><a class="header-anchor" href="#jstack-生成虚拟机当前时刻的线程快照"><span><strong><code v-pre>jstack</code></strong> :生成虚拟机当前时刻的线程快照</span></a></h3>
...
<div class="language-powershell line-numbers-mode" data-ext="powershell" data-title="powershell"><pre v-pre class="language-powershell"><code>Found one Java-level deadlock:
=============================
...
<h2 id="jdk-可视化分析工具" tabindex="-1"><a class="header-anchor" href="#jdk-可视化分析工具"><span>JDK 可视化分析工具</span></a></h2>
<h3 id="jconsole-java-监视与管理控制台" tabindex="-1"><a class="header-anchor" href="#jconsole-java-监视与管理控制台"><span>JConsole:Java 监视与管理控制台</span></a></h3>
<p>JConsole 是基于 JMX 的可视化监视、管理工具。可以很方便的监视本地及远程服务器的 java 进程的内存使用情况。你可以在控制台输入<code v-pre>jconsole</code>命令启动或者在 JDK 目录下的 bin 目录找到<code v-pre>jconsole.exe</code>然后双击启动。</p>
<h4 id="连接-jconsole" tabindex="-1"><a class="header-anchor" href="#连接-jconsole"><span>连接 Jconsole</span></a></h4>
<figure><img src="@source/java-core/jvm/pictures/jdk监控和故障处理工具总结/1JConsole连接.png" alt="连接 Jconsole" tabindex="0"><figcaption>连接 Jconsole</figcaption></figure>
<p>如果需要使用 JConsole 连接远程进程，可以在远程 Java 程序启动时加上下面这些参数:</p>
<div class="language-properties line-numbers-mode" data-ext="properties" data-title="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">-Djava.rmi.server.hostname</span><span class="token punctuation">=</span><span class="token value attr-value">外网访问 ip 地址</span>
...
<div class="language-plain line-numbers-mode" data-ext="plain" data-title="plain"><pre v-pre class="language-plain"><code>外网访问 ip 地址:60001
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="查看-java-程序概况" tabindex="-1"><a class="header-anchor" href="#查看-java-程序概况"><span>查看 Java 程序概况</span></a></h4>
<figure><img src="@source/java-core/jvm/pictures/jdk监控和故障处理工具总结/2查看Java程序概况.png" alt="查看 Java 程序概况 " tabindex="0"><figcaption>查看 Java 程序概况 </figcaption></figure>
<h4 id="内存监控" tabindex="-1"><a class="header-anchor" href="#内存监控"><span>内存监控</span></a></h4>
...
<figure><img src="@source/java-core/jvm/pictures/jdk监控和故障处理工具总结/3内存监控.png" alt="内存监控 " tabindex="0"><figcaption>内存监控 </figcaption></figure>
<h4 id="线程监控" tabindex="-1"><a class="header-anchor" href="#线程监控"><span>线程监控</span></a></h4>
<p>类似我们前面讲的 <code v-pre>jstack</code> 命令，不过这个是可视化的。</p>
<p>最下面有一个&quot;检测死锁 (D)&quot;按钮，点击这个按钮可以自动为你找到发生死锁的线程以及它们的详细信息 。</p>
<figure><img src="@source/java-core/jvm/pictures/jdk监控和故障处理工具总结/4线程监控.png" alt="线程监控 " tabindex="0"><figcaption>线程监控 </figcaption></figure>
<h3 id="visual-vm-多合一故障处理工具" tabindex="-1"><a class="header-anchor" href="#visual-vm-多合一故障处理工具"><span>Visual VM:多合一故障处理工具</span></a></h3>
<p>VisualVM 提供在 Java 虚拟机 (Java Virtual Machine, JVM) 上运行的 Java 应用程序的详细信息。在 VisualVM 的图形用户界面中，您可以方便、快捷地查看多个 Java 应用程序的相关信息。Visual VM 官网：<a href="https://visualvm.github.io/" target="_blank" rel="noopener noreferrer">https://visualvm.github.io/<ExternalLinkIcon/></a> 。Visual VM 中文文档:<a href="https://visualvm.github.io/documentation.html" target="_blank" rel="noopener noreferrer">https://visualvm.github.io/documentation.html<ExternalLinkIcon/></a>。</p>
