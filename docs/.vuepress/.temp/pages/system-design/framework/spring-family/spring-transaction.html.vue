...
<h2 id="什么是事务" tabindex="-1"><a class="header-anchor" href="#什么是事务"><span>什么是事务？</span></a></h2>
...
<figure><img src="https://oss.javaguide.cn/github/javaguide/mysql/事务示意图.png" alt="事务示意图" tabindex="0"><figcaption>事务示意图</figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">OrdersService</span> <span class="token punctuation">{</span>
...
<h2 id="事务的特性-acid-了解么" tabindex="-1"><a class="header-anchor" href="#事务的特性-acid-了解么"><span>事务的特性（ACID）了解么?</span></a></h2>
<ol>
...
<figure><img src="https://oss.javaguide.cn/github/javaguide/mysql/AID-&gt;C.png" alt="AID-&gt;C" tabindex="0"><figcaption>AID-&gt;C</figcaption></figure>
...
<h2 id="详谈-spring-对事务的支持" tabindex="-1"><a class="header-anchor" href="#详谈-spring-对事务的支持"><span>详谈 Spring 对事务的支持</span></a></h2>
<blockquote>
...
<h3 id="spring-支持两种方式的事务管理" tabindex="-1"><a class="header-anchor" href="#spring-支持两种方式的事务管理"><span>Spring 支持两种方式的事务管理</span></a></h3>
<h4 id="编程式事务管理" tabindex="-1"><a class="header-anchor" href="#编程式事务管理"><span>编程式事务管理</span></a></h4>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testTransaction</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token class-name">TransactionStatus</span> status <span class="token operator">=</span> transactionManager<span class="token punctuation">.</span><span class="token function">getTransaction</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token class-name">DefaultTransactionDefinition</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
          ...
          <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="声明式事务管理" tabindex="-1"><a class="header-anchor" href="#声明式事务管理"><span>声明式事务管理</span></a></h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="spring-事务管理接口介绍" tabindex="-1"><a class="header-anchor" href="#spring-事务管理接口介绍"><span>Spring 事务管理接口介绍</span></a></h3>
...
<h4 id="platformtransactionmanager-事务管理接口" tabindex="-1"><a class="header-anchor" href="#platformtransactionmanager-事务管理接口"><span>PlatformTransactionManager:事务管理接口</span></a></h4>
...
<figure><img src="@source/system-design/framework/spring-family/images/spring-transaction/PlatformTransactionManager.png" alt="" tabindex="0"><figcaption></figcaption></figure>
...
<p>我前段时间在我的<a href="https://javaguide.cn/about-the-author/zhishixingqiu-two-years.html" target="_blank" rel="noopener noreferrer">知识星球<ExternalLinkIcon/></a>分享过：<strong>“为什么我们要用接口？”</strong> 。</p>
<blockquote>
...
<h4 id="transactiondefinition-事务属性" tabindex="-1"><a class="header-anchor" href="#transactiondefinition-事务属性"><span>TransactionDefinition:事务属性</span></a></h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="transactionstatus-事务状态" tabindex="-1"><a class="header-anchor" href="#transactionstatus-事务状态"><span>TransactionStatus:事务状态</span></a></h4>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">TransactionStatus</span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="事务属性详解" tabindex="-1"><a class="header-anchor" href="#事务属性详解"><span>事务属性详解</span></a></h3>
<p>实际业务开发中，大家一般都是使用 <code v-pre>@Transactional</code> 注解来开启事务，很多人并不清楚这个注解里面的参数是什么意思，有什么用。为了更好的在项目中使用事务管理，强烈推荐好好阅读一下下面的内容。</p>
<h4 id="事务传播行为" tabindex="-1"><a class="header-anchor" href="#事务传播行为"><span>事务传播行为</span></a></h4>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">TransactionDefinition</span> <span class="token punctuation">{</span>
    <span class="token keyword">int</span> <span class="token constant">PROPAGATION_REQUIRED</span> <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span>
    <span class="token keyword">int</span> <span class="token constant">PROPAGATION_SUPPORTS</span> <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>
    <span class="token keyword">int</span> <span class="token constant">PROPAGATION_MANDATORY</span> <span class="token operator">=</span> <span class="token number">2</span><span class="token punctuation">;</span>
    <span class="token keyword">int</span> <span class="token constant">PROPAGATION_REQUIRES_NEW</span> <span class="token operator">=</span> <span class="token number">3</span><span class="token punctuation">;</span>
...
<p>这里还是简单举个例子：如果 <code v-pre>bMethod()</code> 回滚的话，<code v-pre>aMethod()</code>不会回滚。如果 <code v-pre>aMethod()</code> 回滚的话，<code v-pre>bMethod()</code>会回滚。</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Service</span>
<span class="token class-name">Class</span> <span class="token class-name">A</span> <span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Autowired</span>
    <span class="token class-name">B</span> b<span class="token punctuation">;</span>
...
<p>相关阅读：<a href="https://javaguide.cn/database/mysql/transaction-isolation-level.html" target="_blank" rel="noopener noreferrer">MySQL 事务隔离级别详解<ExternalLinkIcon/></a>。</p>
<h4 id="事务超时属性" tabindex="-1"><a class="header-anchor" href="#事务超时属性"><span>事务超时属性</span></a></h4>
...
<h4 id="事务只读属性" tabindex="-1"><a class="header-anchor" href="#事务只读属性"><span>事务只读属性</span></a></h4>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">org<span class="token punctuation">.</span>springframework<span class="token punctuation">.</span>transaction</span><span class="token punctuation">;</span>
...
<h4 id="事务回滚规则" tabindex="-1"><a class="header-anchor" href="#事务回滚规则"><span>事务回滚规则</span></a></h4>
...
<figure><img src="@source/system-design/framework/spring-family/images/spring-transaction/roollbackFor.png" alt="" tabindex="0"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="transactional-注解使用详解" tabindex="-1"><a class="header-anchor" href="#transactional-注解使用详解"><span>@Transactional 注解使用详解</span></a></h3>
<h4 id="transactional-的作用范围" tabindex="-1"><a class="header-anchor" href="#transactional-的作用范围"><span><code v-pre>@Transactional</code> 的作用范围</span></a></h4>
<ol>
...
<h4 id="transactional-的常用配置参数" tabindex="-1"><a class="header-anchor" href="#transactional-的常用配置参数"><span><code v-pre>@Transactional</code> 的常用配置参数</span></a></h4>
...
<h4 id="transactional-事务注解原理" tabindex="-1"><a class="header-anchor" href="#transactional-事务注解原理"><span><code v-pre>@Transactional</code> 事务注解原理</span></a></h4>
...
<h4 id="spring-aop-自调用问题" tabindex="-1"><a class="header-anchor" href="#spring-aop-自调用问题"><span>Spring AOP 自调用问题</span></a></h4>
<p>当一个方法被标记了<code v-pre>@Transactional</code> 注解的时候，Spring 事务管理器只会在被其他类方法调用的时候生效，而不会在一个类中方法调用生效。</p>
<p>这是因为 Spring AOP 工作原理决定的。因为 Spring AOP 使用动态代理来实现事务的管理，它会在运行的时候为带有 <code v-pre>@Transactional</code> 注解的方法生成代理对象，并在方法调用的前后应用事物逻辑。如果该方法被其他类调用我们的代理对象就会拦截方法调用并处理事务。但是在一个类中的其他方法内部调用的时候，我们代理对象就无法拦截到这个内部调用，因此事务也就失效了。</p>
...
<p><a href="https://github.com/Snailclimb/JavaGuide/issues/2091" target="_blank" rel="noopener noreferrer">issue #2091<ExternalLinkIcon/></a>补充了一个例子：</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Service</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyService</span> <span class="token punctuation">{</span>

<span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">method1</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
     <span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token class-name">MyService</span><span class="token punctuation">)</span><span class="token class-name">AopContext</span><span class="token punctuation">.</span><span class="token function">currentProxy</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">method2</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 先获取该类的代理对象，然后通过代理对象调用method2。</span>
     <span class="token comment">//......</span>
<span class="token punctuation">}</span>
<span class="token annotation punctuation">@Transactional</span>
 <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">method2</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的代码确实可以在自调用的时候开启事务，但是这是因为使用了 <code v-pre>AopContext.currentProxy()</code> 方法来获取当前类的代理对象，然后通过代理对象调用 <code v-pre>method2()</code>。这样就相当于从外部调用了 <code v-pre>method2()</code>，所以事务注解才会生效。我们一般也不会在代码中这么写，所以可以忽略这个特殊的例子。</p>
<h4 id="transactional-的使用注意事项总结" tabindex="-1"><a class="header-anchor" href="#transactional-的使用注意事项总结"><span><code v-pre>@Transactional</code> 的使用注意事项总结</span></a></h4>
<ul>
