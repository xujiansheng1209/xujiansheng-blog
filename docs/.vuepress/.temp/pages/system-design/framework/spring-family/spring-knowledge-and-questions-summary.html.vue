<template><div><p>这篇文章主要是想通过一些问题，加深大家对于 Spring 的理解，所以不会涉及太多的代码！</p>
...
<h2 id="spring-基础" tabindex="-1"><a class="header-anchor" href="#spring-基础"><span>Spring 基础</span></a></h2>
<h3 id="什么是-spring-框架" tabindex="-1"><a class="header-anchor" href="#什么是-spring-框架"><span>什么是 Spring 框架?</span></a></h3>
...
<figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/38ef122122de4375abcd27c3de8f60b4.png" alt="" tabindex="0"><figcaption></figcaption></figure>
...
<li>GitHub 地址： <a href="https://github.com/spring-projects/spring-framework" target="_blank" rel="noopener noreferrer">https://github.com/spring-projects/spring-framework<ExternalLinkIcon/></a></li>
</ul>
<h3 id="spring-包含的模块有哪些" tabindex="-1"><a class="header-anchor" href="#spring-包含的模块有哪些"><span>Spring 包含的模块有哪些？</span></a></h3>
<p><strong>Spring4.x 版本</strong>：</p>
<figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/jvme0c60b4606711fc4a0b6faf03230247a.png" alt="Spring4.x主要模块" tabindex="0"><figcaption>Spring4.x主要模块</figcaption></figure>
<p><strong>Spring5.x 版本</strong>：</p>
<figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/20200831175708.png" alt="Spring5.x主要模块" tabindex="0"><figcaption>Spring5.x主要模块</figcaption></figure>
<p>Spring5.x 版本中 Web 模块的 Portlet 组件已经被废弃掉，同时增加了用于异步响应式处理的 WebFlux 组件。</p>
<p>Spring 各个模块的依赖关系如下：</p>
<figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/20200902100038.png" alt="Spring 各个模块的依赖关系" tabindex="0"><figcaption>Spring 各个模块的依赖关系</figcaption></figure>
<h4 id="core-container" tabindex="-1"><a class="header-anchor" href="#core-container"><span>Core Container</span></a></h4>
...
<h4 id="aop" tabindex="-1"><a class="header-anchor" href="#aop"><span>AOP</span></a></h4>
<ul>
...
<h4 id="data-access-integration" tabindex="-1"><a class="header-anchor" href="#data-access-integration"><span>Data Access/Integration</span></a></h4>
<ul>
...
<h4 id="spring-web" tabindex="-1"><a class="header-anchor" href="#spring-web"><span>Spring Web</span></a></h4>
<ul>
...
<h4 id="messaging" tabindex="-1"><a class="header-anchor" href="#messaging"><span>Messaging</span></a></h4>
<p><strong>spring-messaging</strong> 是从 Spring4.0 开始新加入的一个模块，主要职责是为 Spring 框架集成一些基础的报文传送应用。</p>
<h4 id="spring-test" tabindex="-1"><a class="header-anchor" href="#spring-test"><span>Spring Test</span></a></h4>
...
<h3 id="spring-spring-mvc-spring-boot-之间什么关系" tabindex="-1"><a class="header-anchor" href="#spring-spring-mvc-spring-boot-之间什么关系"><span>Spring,Spring MVC,Spring Boot 之间什么关系?</span></a></h3>
...
<figure><img src="https://oss.javaguide.cn/github/javaguide/jvme0c60b4606711fc4a0b6faf03230247a.png" alt="Spring主要模块" tabindex="0"><figcaption>Spring主要模块</figcaption></figure>
...
<figure><img src="https://oss.javaguide.cn/java-guide-blog/image-20210809181452421.png" alt="" tabindex="0"><figcaption></figcaption></figure>
...
<h3 id="谈谈自己对于-spring-ioc-的了解" tabindex="-1"><a class="header-anchor" href="#谈谈自己对于-spring-ioc-的了解"><span>谈谈自己对于 Spring IoC 的了解</span></a></h3>
...
<li><RouteLink to="/system-design/framework/spring-family/ioc-and-aop.html">IoC &amp; AOP 详解（快速搞懂）</RouteLink></li>
</ul>
<h3 id="什么是-spring-bean" tabindex="-1"><a class="header-anchor" href="#什么是-spring-bean"><span>什么是 Spring Bean？</span></a></h3>
<p>简单来说，Bean 代指的就是那些被 IoC 容器所管理的对象。</p>
<p>我们需要告诉 IoC 容器帮助我们管理哪些对象，这个是通过配置元数据来定义的。配置元数据可以是 XML 文件、注解或者 Java 配置类。</p>
<div class="language-xml line-numbers-mode" data-ext="xml" data-title="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- Constructor-arg with 'value' attribute --></span>
...
<figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/062b422bd7ac4d53afd28fb74b2bc94d.png" alt="" tabindex="0"><figcaption></figcaption></figure>
...
<h3 id="将一个类声明为-bean-的注解有哪些" tabindex="-1"><a class="header-anchor" href="#将一个类声明为-bean-的注解有哪些"><span>将一个类声明为 Bean 的注解有哪些?</span></a></h3>
<ul>
...
<li><code v-pre>@Controller</code> : 对应 Spring MVC 控制层，主要用于接受用户请求并调用 <code v-pre>Service</code> 层返回数据给前端页面。</li>
</ul>
<h3 id="component-和-bean-的区别是什么" tabindex="-1"><a class="header-anchor" href="#component-和-bean-的区别是什么"><span>@Component 和 @Bean 的区别是什么？</span></a></h3>
<ul>
...
<div class="language-xml line-numbers-mode" data-ext="xml" data-title="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>beans</span><span class="token punctuation">></span></span>
...
<span class="token keyword">public</span> <span class="token class-name">OneService</span> <span class="token function">getService</span><span class="token punctuation">(</span>status<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="注入-bean-的注解有哪些" tabindex="-1"><a class="header-anchor" href="#注入-bean-的注解有哪些"><span>注入 Bean 的注解有哪些？</span></a></h3>
...
<td><code v-pre>org.springframework.bean.factory</code></td>
<td>Spring 2.5+</td>
</tr>
<tr>
<td><code v-pre>@Resource</code></td>
<td><code v-pre>javax.annotation</code></td>
<td>Java JSR-250</td>
</tr>
<tr>
<td><code v-pre>@Inject</code></td>
<td><code v-pre>javax.inject</code></td>
<td>Java JSR-330</td>
</tr>
</tbody>
</table>
<p><code v-pre>@Autowired</code> 和<code v-pre>@Resource</code>使用的比较多一些。</p>
<h3 id="autowired-和-resource-的区别是什么" tabindex="-1"><a class="header-anchor" href="#autowired-和-resource-的区别是什么"><span>@Autowired 和 @Resource 的区别是什么？</span></a></h3>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// smsService 就是我们上面所说的名称</span>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// 报错，byName 和 byType 都无法匹配到 bean</span>
<span class="token annotation punctuation">@Autowired</span>
<span class="token keyword">private</span> <span class="token class-name">SmsService</span> smsService<span class="token punctuation">;</span>
...
<span class="token keyword">private</span> <span class="token class-name">SmsService</span> smsService<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们还是建议通过 <code v-pre>@Qualifier</code> 注解来显式指定名称而不是依赖变量的名称。</p>
<p><code v-pre>@Resource</code>属于 JDK 提供的注解，默认注入方式为 <code v-pre>byName</code>。如果无法通过名称匹配到对应的 Bean 的话，注入方式会变为<code v-pre>byType</code>。</p>
<p><code v-pre>@Resource</code> 有两个比较重要且日常开发常用的属性：<code v-pre>name</code>（名称）、<code v-pre>type</code>（类型）。</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token annotation punctuation">@interface</span> <span class="token class-name">Resource</span> <span class="token punctuation">{</span>
...
<li>当一个接口存在多个实现类的情况下，<code v-pre>@Autowired</code> 和<code v-pre>@Resource</code>都需要通过名称才能正确匹配到对应的 Bean。<code v-pre>Autowired</code> 可以通过 <code v-pre>@Qualifier</code> 注解来显式指定名称，<code v-pre>@Resource</code>可以通过 <code v-pre>name</code> 属性来显式指定名称。</li>
<li><code v-pre>@Autowired</code> 支持在构造函数、方法、字段和参数上使用。<code v-pre>@Resource</code> 主要用于字段和方法上的注入，不支持在构造函数或参数上使用。</li>
</ul>
<h3 id="bean-的作用域有哪些" tabindex="-1"><a class="header-anchor" href="#bean-的作用域有哪些"><span>Bean 的作用域有哪些?</span></a></h3>
<p>Spring 中 Bean 的作用域通常有下面几种：</p>
<ul>
<li><strong>singleton</strong> : IoC 容器中只有唯一的 bean 实例。Spring 中的 bean 默认都是单例的，是对单例设计模式的应用。</li>
<li><strong>prototype</strong> : 每次获取都会创建一个新的 bean 实例。也就是说，连续 <code v-pre>getBean()</code> 两次，得到的是不同的 Bean 实例。</li>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="bean-是线程安全的吗" tabindex="-1"><a class="header-anchor" href="#bean-是线程安全的吗"><span>Bean 是线程安全的吗？</span></a></h3>
...
<h3 id="bean-的生命周期了解么" tabindex="-1"><a class="header-anchor" href="#bean-的生命周期了解么"><span>Bean 的生命周期了解么?</span></a></h3>
<ul>
...
<p>图示：</p>
<figure><img src="https://images.xiaozhuanlan.com/photo/2019/24bc2bad3ce28144d60d9e0a2edf6c7f.jpg" alt="Spring Bean 生命周期" tabindex="0"><figcaption>Spring Bean 生命周期</figcaption></figure>
<p>与之比较类似的中文版本:</p>
<figure><img src="https://images.xiaozhuanlan.com/photo/2019/b5d264565657a5395c2781081a7483e1.jpg" alt="Spring Bean 生命周期" tabindex="0"><figcaption>Spring Bean 生命周期</figcaption></figure>
<h2 id="spring-aop" tabindex="-1"><a class="header-anchor" href="#spring-aop"><span>Spring AOP</span></a></h2>
<h3 id="谈谈自己对于-aop-的了解" tabindex="-1"><a class="header-anchor" href="#谈谈自己对于-aop-的了解"><span>谈谈自己对于 AOP 的了解</span></a></h3>
...
<h3 id="spring-aop-和-aspectj-aop-有什么区别" tabindex="-1"><a class="header-anchor" href="#spring-aop-和-aspectj-aop-有什么区别"><span>Spring AOP 和 AspectJ AOP 有什么区别？</span></a></h3>
...
<h3 id="aspectj-定义的通知类型有哪些" tabindex="-1"><a class="header-anchor" href="#aspectj-定义的通知类型有哪些"><span>AspectJ 定义的通知类型有哪些？</span></a></h3>
<ul>
...
<h3 id="多个切面的执行顺序如何控制" tabindex="-1"><a class="header-anchor" href="#多个切面的执行顺序如何控制"><span>多个切面的执行顺序如何控制？</span></a></h3>
<p>1、通常使用<code v-pre>@Order</code> 注解直接定义切面顺序</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// 值越小优先级越高</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2、实现<code v-pre>Ordered</code> 接口重写 <code v-pre>getOrder</code> 方法。</strong></p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">LoggingAspect</span> <span class="token keyword">implements</span> <span class="token class-name">Ordered</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="spring-mvc" tabindex="-1"><a class="header-anchor" href="#spring-mvc"><span>Spring MVC</span></a></h2>
<h3 id="说说自己对于-spring-mvc-了解" tabindex="-1"><a class="header-anchor" href="#说说自己对于-spring-mvc-了解"><span>说说自己对于 Spring MVC 了解?</span></a></h3>
...
<figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/159b3d3e70dd45e6afa81bf06d09264e.png" alt="" tabindex="0"><figcaption></figcaption></figure>
...
<figure><img src="https://oss.javaguide.cn/java-guide-blog/mvc-mode1.png" alt="mvc-mode1" tabindex="0"><figcaption>mvc-mode1</figcaption></figure>
...
<figure><img src="https://oss.javaguide.cn/java-guide-blog/mvc-model2.png" alt="" tabindex="0"><figcaption></figcaption></figure>
...
<h3 id="spring-mvc-的核心组件有哪些" tabindex="-1"><a class="header-anchor" href="#spring-mvc-的核心组件有哪些"><span>Spring MVC 的核心组件有哪些？</span></a></h3>
<p>记住了下面这些组件，也就记住了 SpringMVC 的工作原理。</p>
<ul>
<li><strong><code v-pre>DispatcherServlet</code></strong>：<strong>核心的中央处理器</strong>，负责接收请求、分发，并给予客户端响应。</li>
<li><strong><code v-pre>HandlerMapping</code></strong>：<strong>处理器映射器</strong>，根据 URL 去匹配查找能处理的 <code v-pre>Handler</code> ，并会将请求涉及到的拦截器和 <code v-pre>Handler</code> 一起封装。</li>
<li><strong><code v-pre>HandlerAdapter</code></strong>：<strong>处理器适配器</strong>，根据 <code v-pre>HandlerMapping</code> 找到的 <code v-pre>Handler</code> ，适配执行对应的 <code v-pre>Handler</code>；</li>
<li><strong><code v-pre>Handler</code></strong>：<strong>请求处理器</strong>，处理实际请求的处理器。</li>
<li><strong><code v-pre>ViewResolver</code></strong>：<strong>视图解析器</strong>，根据 <code v-pre>Handler</code> 返回的逻辑视图 / 视图，解析并渲染真正的视图，并传递给 <code v-pre>DispatcherServlet</code> 响应客户端</li>
</ul>
<h3 id="springmvc-工作原理了解吗" tabindex="-1"><a class="header-anchor" href="#springmvc-工作原理了解吗"><span>SpringMVC 工作原理了解吗?</span></a></h3>
<p><strong>Spring MVC 原理如下图所示：</strong></p>
<blockquote>
<p>SpringMVC 工作原理的图解我没有自己画，直接图省事在网上找了一个非常清晰直观的，原出处不明。</p>
</blockquote>
<figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/de6d2b213f112297298f3e223bf08f28.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<p><strong>流程说明（重要）：</strong></p>
<ol>
<li>客户端（浏览器）发送请求， <code v-pre>DispatcherServlet</code>拦截请求。</li>
<li><code v-pre>DispatcherServlet</code> 根据请求信息调用 <code v-pre>HandlerMapping</code> 。<code v-pre>HandlerMapping</code> 根据 URL 去匹配查找能处理的 <code v-pre>Handler</code>（也就是我们平常说的 <code v-pre>Controller</code> 控制器） ，并会将请求涉及到的拦截器和 <code v-pre>Handler</code> 一起封装。</li>
<li><code v-pre>DispatcherServlet</code> 调用 <code v-pre>HandlerAdapter</code>适配器执行 <code v-pre>Handler</code> 。</li>
<li><code v-pre>Handler</code> 完成对用户请求的处理后，会返回一个 <code v-pre>ModelAndView</code> 对象给<code v-pre>DispatcherServlet</code>，<code v-pre>ModelAndView</code> 顾名思义，包含了数据模型以及相应的视图的信息。<code v-pre>Model</code> 是返回的数据对象，<code v-pre>View</code> 是个逻辑上的 <code v-pre>View</code>。</li>
...
<h3 id="统一异常处理怎么做" tabindex="-1"><a class="header-anchor" href="#统一异常处理怎么做"><span>统一异常处理怎么做？</span></a></h3>
<p>推荐使用注解的方式统一异常处理，具体会使用到 <code v-pre>@ControllerAdvice</code> + <code v-pre>@ExceptionHandler</code> 这两个注解 。</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ControllerAdvice</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">GlobalExceptionHandler</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这种异常处理方式下，会给所有或者指定的 <code v-pre>Controller</code> 织入异常处理的逻辑（AOP），当 <code v-pre>Controller</code> 中的方法抛出异常的时候，由被<code v-pre>@ExceptionHandler</code> 注解修饰的方法进行处理。</p>
<p><code v-pre>ExceptionHandlerMethodResolver</code> 中 <code v-pre>getMappedMethod</code> 方法决定了异常具体被哪个被 <code v-pre>@ExceptionHandler</code> 注解修饰的方法处理异常。</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Nullable</span>
  <span class="token keyword">private</span> <span class="token class-name">Method</span> <span class="token function">getMappedMethod</span><span class="token punctuation">(</span><span class="token class-name">Class</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span> <span class="token keyword">extends</span> <span class="token class-name">Throwable</span><span class="token punctuation">></span></span> exceptionType<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">//找到可以处理的所有异常信息。mappedMethods 中存放了异常和处理异常的方法的对应关系</span>
    <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token class-name">Class</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span> <span class="token keyword">extends</span> <span class="token class-name">Throwable</span><span class="token punctuation">></span></span> mappedException <span class="token operator">:</span> <span class="token keyword">this</span><span class="token punctuation">.</span>mappedMethods<span class="token punctuation">.</span><span class="token function">keySet</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      ...
      <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
    <span class="token comment">// 不为空说明有方法处理异常</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token operator">!</span>matches<span class="token punctuation">.</span><span class="token function">isEmpty</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token comment">// 按照匹配程度从小到大排序</span>
      ...
      <span class="token comment">// 返回处理异常的方法</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从源代码看出：<strong><code v-pre>getMappedMethod()</code>会首先找到可以匹配处理异常的所有方法信息，然后对其进行从小到大的排序，最后取最小的那一个匹配的方法(即匹配度最高的那个)。</strong></p>
<h2 id="spring-框架中用到了哪些设计模式" tabindex="-1"><a class="header-anchor" href="#spring-框架中用到了哪些设计模式"><span>Spring 框架中用到了哪些设计模式？</span></a></h2>
<blockquote>
<p>关于下面这些设计模式的详细介绍，可以看我写的 <a href="https://javaguide.cn/system-design/framework/spring/spring-design-patterns-summary.html" target="_blank" rel="noopener noreferrer">Spring 中的设计模式详解<ExternalLinkIcon/></a> 这篇文章。</p>
</blockquote>
<ul>
...
<h2 id="spring-事务" tabindex="-1"><a class="header-anchor" href="#spring-事务"><span>Spring 事务</span></a></h2>
<p>关于 Spring 事务的详细介绍，可以看我写的 <a href="https://javaguide.cn/system-design/framework/spring/spring-transaction.html" target="_blank" rel="noopener noreferrer">Spring 事务详解<ExternalLinkIcon/></a> 这篇文章。</p>
<h3 id="spring-管理事务的方式有几种" tabindex="-1"><a class="header-anchor" href="#spring-管理事务的方式有几种"><span>Spring 管理事务的方式有几种？</span></a></h3>
<ul>
<li><strong>编程式事务</strong>：在代码中硬编码(在分布式系统中推荐使用) : 通过 <code v-pre>TransactionTemplate</code>或者 <code v-pre>TransactionManager</code> 手动管理事务，事务范围过大会出现事务未提交导致超时，因此事务要比锁的粒度更小。</li>
<li><strong>声明式事务</strong>：在 XML 配置文件中配置或者直接基于注解（单体应用或者简单业务系统推荐使用） : 实际是通过 AOP 实现（基于<code v-pre>@Transactional</code> 的全注解方式使用最多）</li>
</ul>
<h3 id="spring-事务中哪几种事务传播行为" tabindex="-1"><a class="header-anchor" href="#spring-事务中哪几种事务传播行为"><span>Spring 事务中哪几种事务传播行为?</span></a></h3>
...
<h3 id="spring-事务中的隔离级别有哪几种" tabindex="-1"><a class="header-anchor" href="#spring-事务中的隔离级别有哪几种"><span>Spring 事务中的隔离级别有哪几种?</span></a></h3>
<p>和事务传播行为这块一样，为了方便使用，Spring 也相应地定义了一个枚举类：<code v-pre>Isolation</code></p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">enum</span> <span class="token class-name">Isolation</span> <span class="token punctuation">{</span>
...
<h3 id="transactional-rollbackfor-exception-class-注解了解吗" tabindex="-1"><a class="header-anchor" href="#transactional-rollbackfor-exception-class-注解了解吗"><span>@Transactional(rollbackFor = Exception.class)注解了解吗？</span></a></h3>
<p><code v-pre>Exception</code> 分为运行时异常 <code v-pre>RuntimeException</code> 和非运行时异常。事务管理对于企业应用来说是至关重要的，即使出现异常情况，它也可以保证数据的一致性。</p>
<p>当 <code v-pre>@Transactional</code> 注解作用于类上时，该类的所有 public 方法将都具有该类型的事务属性，同时，我们也可以在方法级别使用该标注来覆盖类级别的定义。</p>
<p><code v-pre>@Transactional</code> 注解默认回滚策略是只有在遇到<code v-pre>RuntimeException</code>(运行时异常) 或者 <code v-pre>Error</code> 时才会回滚事务，而不会回滚 <code v-pre>Checked Exception</code>（受检查异常）。这是因为 Spring 认为<code v-pre>RuntimeException</code>和 Error 是不可预期的错误，而受检异常是可预期的错误，可以通过业务逻辑来处理。</p>
<figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/spring-transactional-rollbackfor.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<p>如果想要修改默认的回滚策略，可以使用 <code v-pre>@Transactional</code> 注解的 <code v-pre>rollbackFor</code> 和 <code v-pre>noRollbackFor</code> 属性来指定哪些异常需要回滚，哪些异常不需要回滚。例如，如果想要让所有的异常都回滚事务，可以使用如下的注解：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果想要让某些特定的异常不回滚事务，可以使用如下的注解：</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Transactional</span><span class="token punctuation">(</span>noRollbackFor <span class="token operator">=</span> <span class="token class-name">CustomException</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">someMethod</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
<span class="token comment">// some business logic</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="spring-data-jpa" tabindex="-1"><a class="header-anchor" href="#spring-data-jpa"><span>Spring Data JPA</span></a></h2>
<p>JPA 重要的是实战，这里仅对小部分知识点进行总结。</p>
<h3 id="如何使用-jpa-在数据库中非持久化一个字段" tabindex="-1"><a class="header-anchor" href="#如何使用-jpa-在数据库中非持久化一个字段"><span>如何使用 JPA 在数据库中非持久化一个字段？</span></a></h3>
<p>假如我们有下面一个类：</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Entity</span><span class="token punctuation">(</span>name<span class="token operator">=</span><span class="token string">"USER"</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">static</span> <span class="token class-name">String</span> transient1<span class="token punctuation">;</span> <span class="token comment">// not persistent because of static</span>
...
<h3 id="jpa-的审计功能是做什么的-有什么用" tabindex="-1"><a class="header-anchor" href="#jpa-的审计功能是做什么的-有什么用"><span>JPA 的审计功能是做什么的？有什么用？</span></a></h3>
...
<h3 id="实体之间的关联关系注解有哪些" tabindex="-1"><a class="header-anchor" href="#实体之间的关联关系注解有哪些"><span>实体之间的关联关系注解有哪些？</span></a></h3>
<ul>
<li><code v-pre>@OneToOne</code> : 一对一。</li>
<li><code v-pre>@ManyToMany</code>：多对多。</li>
<li><code v-pre>@OneToMany</code> : 一对多。</li>
<li><code v-pre>@ManyToOne</code>：多对一。</li>
</ul>
<p>利用 <code v-pre>@ManyToOne</code> 和 <code v-pre>@OneToMany</code> 也可以表达多对多的关联关系。</p>
...
<h3 id="有哪些控制请求访问权限的方法" tabindex="-1"><a class="header-anchor" href="#有哪些控制请求访问权限的方法"><span>有哪些控制请求访问权限的方法？</span></a></h3>
<figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/image-20220728201854641.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<ul>
<li><code v-pre>permitAll()</code>：无条件允许任何形式访问，不管你登录还是没有登录。</li>
<li><code v-pre>anonymous()</code>：允许匿名访问，也就是没有登录才可以访问。</li>
<li><code v-pre>denyAll()</code>：无条件决绝任何形式的访问。</li>
...
<h3 id="hasrole-和-hasauthority-有区别吗" tabindex="-1"><a class="header-anchor" href="#hasrole-和-hasauthority-有区别吗"><span>hasRole 和 hasAuthority 有区别吗？</span></a></h3>
<p>可以看看松哥的这篇文章：<a href="https://mp.weixin.qq.com/s/GTNOa2k9_n_H0w24upClRw" target="_blank" rel="noopener noreferrer">Spring Security 中的 hasRole 和 hasAuthority 有区别吗？<ExternalLinkIcon/></a>，介绍的比较详细。</p>
<h3 id="如何对密码进行加密" tabindex="-1"><a class="header-anchor" href="#如何对密码进行加密"><span>如何对密码进行加密？</span></a></h3>
<p>如果我们需要保存密码这类敏感数据到数据库的话，需要先加密再保存。</p>
<p>Spring Security 提供了多种加密算法的实现，开箱即用，非常方便。这些加密算法实现类的接口是 <code v-pre>PasswordEncoder</code> ，如果你想要自己实现一个加密算法的话，也需要实现 <code v-pre>PasswordEncoder</code> 接口。</p>
<p><code v-pre>PasswordEncoder</code> 接口一共也就 3 个必须实现的方法。</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">PasswordEncoder</span> <span class="token punctuation">{</span>
    <span class="token comment">// 加密也就是对原始密码进行编码</span>
    ...
    <span class="token comment">// 比对原始密码和数据库中保存的密码</span>
    ...
    <span class="token comment">// 判断加密密码是否需要再次进行加密，默认返回 false</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://oss.javaguide.cn/github/javaguide/system-design/framework/spring/image-20220728183540954.png" alt="" tabindex="0"><figcaption></figcaption></figure>
<p>官方推荐使用基于 bcrypt 强哈希函数的加密算法实现类。</p>
<h3 id="如何优雅更换系统使用的加密算法" tabindex="-1"><a class="header-anchor" href="#如何优雅更换系统使用的加密算法"><span>如何优雅更换系统使用的加密算法？</span></a></h3>
<p>如果我们在开发过程中，突然发现现有的加密算法无法满足我们的需求，需要更换成另外一个加密算法，这个时候应该怎么办呢？</p>
<p>推荐的做法是通过 <code v-pre>DelegatingPasswordEncoder</code> 兼容多种不同的密码加密方案，以适应不同的业务需求。</p>
<p>从名字也能看出来，<code v-pre>DelegatingPasswordEncoder</code> 其实就是一个代理类，并非是一种全新的加密算法，它做的事情就是代理上面提到的加密算法实现类。在 Spring Security 5.0 之后，默认就是基于 <code v-pre>DelegatingPasswordEncoder</code> 进行密码加密的。</p>
<h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考"><span>参考</span></a></h2>
<ul>
<li>《Spring 技术内幕》</li>
<li>《从零开始深入学习 Spring》：<a href="https://juejin.cn/book/6857911863016390663" target="_blank" rel="noopener noreferrer">https://juejin.cn/book/6857911863016390663<ExternalLinkIcon/></a></li>
...
<li><a href="https://www.cnblogs.com/clwydjgs/p/9317849.html" target="_blank" rel="noopener noreferrer">https://www.cnblogs.com/clwydjgs/p/9317849.html<ExternalLinkIcon/></a></li>
