<template><div><p>“JDK 中用到了哪些设计模式? Spring 中用到了哪些设计模式? ”这两个问题，在面试中比较常见。</p>
...
<h2 id="控制反转-ioc-和依赖注入-di" tabindex="-1"><a class="header-anchor" href="#控制反转-ioc-和依赖注入-di"><span>控制反转(IoC)和依赖注入(DI)</span></a></h2>
...
<figure><img src="https://oss.javaguide.cn/github/javaguide/ioc-patterns.png" alt="ioc-patterns" tabindex="0"><figcaption>ioc-patterns</figcaption></figure>
...
<blockquote>
<p>关于 Spring IOC 的理解，推荐看这一下知乎的一个回答：<a href="https://www.zhihu.com/question/23277575/answer/169698662" target="_blank" rel="noopener noreferrer">https://www.zhihu.com/question/23277575/answer/169698662<ExternalLinkIcon/></a> ，非常不错。</p>
</blockquote>
...
<h2 id="工厂设计模式" tabindex="-1"><a class="header-anchor" href="#工厂设计模式"><span>工厂设计模式</span></a></h2>
<p>Spring 使用工厂模式可以通过 <code v-pre>BeanFactory</code> 或 <code v-pre>ApplicationContext</code> 创建 bean 对象。</p>
...
<p><code v-pre>ApplicationContext</code> 的三个实现类：</p>
<ol>
...
<li><code v-pre>XmlWebApplicationContext</code>：从 Web 系统中的 XML 文件载入上下文定义信息。</li>
</ol>
<p>Example:</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="单例设计模式" tabindex="-1"><a class="header-anchor" href="#单例设计模式"><span>单例设计模式</span></a></h2>
...
<p>Spring 通过 <code v-pre>ConcurrentHashMap</code> 实现单例注册表的特殊方式实现单例模式。</p>
<p>Spring 实现单例的核心代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// 通过 ConcurrentHashMap（线程安全） 实现单例注册表</span>
...
<span class="token keyword">public</span> <span class="token class-name">Object</span> <span class="token function">getSingleton</span><span class="token punctuation">(</span><span class="token class-name">String</span> beanName<span class="token punctuation">,</span> <span class="token class-name">ObjectFactory</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span><span class="token punctuation">></span></span> singletonFactory<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">addSingleton</span><span class="token punctuation">(</span><span class="token class-name">String</span> beanName<span class="token punctuation">,</span> <span class="token class-name">Object</span> singletonObject<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>单例 Bean 存在线程安全问题吗？</strong></p>
...
<h2 id="代理设计模式" tabindex="-1"><a class="header-anchor" href="#代理设计模式"><span>代理设计模式</span></a></h2>
<h3 id="代理模式在-aop-中的应用" tabindex="-1"><a class="header-anchor" href="#代理模式在-aop-中的应用"><span>代理模式在 AOP 中的应用</span></a></h3>
...
<figure><img src="https://oss.javaguide.cn/github/javaguide/SpringAOPProcess.jpg" alt="SpringAOPProcess" tabindex="0"><figcaption>SpringAOPProcess</figcaption></figure>
...
<h2 id="模板方法" tabindex="-1"><a class="header-anchor" href="#模板方法"><span>模板方法</span></a></h2>
<p>模板方法模式是一种行为设计模式，它定义一个操作中的算法的骨架，而将一些步骤延迟到子类中。 模板方法使得子类可以不改变一个算法的结构即可重定义该算法的某些特定步骤的实现方式。</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Template</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Spring 中 <code v-pre>JdbcTemplate</code>、<code v-pre>HibernateTemplate</code> 等以 Template 结尾的对数据库操作的类，它们就使用到了模板模式。一般情况下，我们都是使用继承的方式来实现模板模式，但是 Spring 并没有使用这种方式，而是使用 Callback 模式与模板方法模式配合，既达到了代码复用的效果，同时增加了灵活性。</p>
<h2 id="观察者模式" tabindex="-1"><a class="header-anchor" href="#观察者模式"><span>观察者模式</span></a></h2>
<p>观察者模式是一种对象行为型模式。它表示的是一种对象与对象之间具有依赖关系，当一个对象发生改变的时候，依赖这个对象的所有对象也会做出反应。Spring 事件驱动模型就是观察者模式很经典的一个应用。Spring 事件驱动模型非常有用，在很多场景都可以解耦我们的代码。比如我们每次添加商品的时候都需要重新更新商品索引，这个时候就可以利用观察者模式来解决这个问题。</p>
<h3 id="spring-事件驱动模型中的三种角色" tabindex="-1"><a class="header-anchor" href="#spring-事件驱动模型中的三种角色"><span>Spring 事件驱动模型中的三种角色</span></a></h3>
<h4 id="事件角色" tabindex="-1"><a class="header-anchor" href="#事件角色"><span>事件角色</span></a></h4>
...
<figure><img src="https://oss.javaguide.cn/github/javaguide/ApplicationEvent-Subclass.png" alt="ApplicationEvent-Subclass" tabindex="0"><figcaption>ApplicationEvent-Subclass</figcaption></figure>
<h4 id="事件监听者角色" tabindex="-1"><a class="header-anchor" href="#事件监听者角色"><span>事件监听者角色</span></a></h4>
<p><code v-pre>ApplicationListener</code> 充当了事件监听者角色，它是一个接口，里面只定义了一个 <code v-pre>onApplicationEvent()</code>方法来处理<code v-pre>ApplicationEvent</code>。<code v-pre>ApplicationListener</code>接口类源码如下，可以看出接口定义看出接口中的事件只要实现了 <code v-pre>ApplicationEvent</code>就可以了。所以，在 Spring 中我们只要实现 <code v-pre>ApplicationListener</code> 接口的 <code v-pre>onApplicationEvent()</code> 方法即可完成监听事件</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="事件发布者角色" tabindex="-1"><a class="header-anchor" href="#事件发布者角色"><span>事件发布者角色</span></a></h4>
<p><code v-pre>ApplicationEventPublisher</code> 充当了事件的发布者，它也是一个接口。</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@FunctionalInterface</span>
...
<h3 id="spring-的事件流程总结" tabindex="-1"><a class="header-anchor" href="#spring-的事件流程总结"><span>Spring 的事件流程总结</span></a></h3>
<ol>
...
<p>Example:</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// 定义一个事件,继承自ApplicationEvent并且写相应的构造函数</span>
...
<h2 id="适配器模式" tabindex="-1"><a class="header-anchor" href="#适配器模式"><span>适配器模式</span></a></h2>
<p>适配器模式(Adapter Pattern) 将一个接口转换成客户希望的另一个接口，适配器模式使接口不兼容的那些类可以一起工作。</p>
<h3 id="spring-aop-中的适配器模式" tabindex="-1"><a class="header-anchor" href="#spring-aop-中的适配器模式"><span>Spring AOP 中的适配器模式</span></a></h3>
<p>我们知道 Spring AOP 的实现是基于代理模式，但是 Spring AOP 的增强或通知(Advice)使用到了适配器模式，与之相关的接口是<code v-pre>AdvisorAdapter</code> 。</p>
<p>Advice 常用的类型有：<code v-pre>BeforeAdvice</code>（目标方法调用前,前置通知）、<code v-pre>AfterAdvice</code>（目标方法调用后,后置通知）、<code v-pre>AfterReturningAdvice</code>(目标方法执行结束后，return 之前)等等。每个类型 Advice（通知）都有对应的拦截器:<code v-pre>MethodBeforeAdviceInterceptor</code>、<code v-pre>AfterReturningAdviceInterceptor</code>、<code v-pre>ThrowsAdviceInterceptor</code> 等等。</p>
<p>Spring 预定义的通知要通过对应的适配器，适配成 <code v-pre>MethodInterceptor</code> 接口(方法拦截器)类型的对象（如：<code v-pre>MethodBeforeAdviceAdapter</code> 通过调用 <code v-pre>getInterceptor</code> 方法，将 <code v-pre>MethodBeforeAdvice</code> 适配成 <code v-pre>MethodBeforeAdviceInterceptor</code> ）。</p>
<h3 id="spring-mvc-中的适配器模式" tabindex="-1"><a class="header-anchor" href="#spring-mvc-中的适配器模式"><span>Spring MVC 中的适配器模式</span></a></h3>
<p>在 Spring MVC 中，<code v-pre>DispatcherServlet</code> 根据请求信息调用 <code v-pre>HandlerMapping</code>，解析请求对应的 <code v-pre>Handler</code>。解析到对应的 <code v-pre>Handler</code>（也就是我们平常说的 <code v-pre>Controller</code> 控制器）后，开始由<code v-pre>HandlerAdapter</code> 适配器处理。<code v-pre>HandlerAdapter</code> 作为期望接口，具体的适配器实现类用于对目标类进行适配，<code v-pre>Controller</code> 作为需要适配的类。</p>
<p><strong>为什么要在 Spring MVC 中使用适配器模式？</strong></p>
<p>Spring MVC 中的 <code v-pre>Controller</code> 种类众多，不同类型的 <code v-pre>Controller</code> 通过不同的方法来对请求进行处理。如果不利用适配器模式的话，<code v-pre>DispatcherServlet</code> 直接获取对应类型的 <code v-pre>Controller</code>，需要的自行来判断，像下面这段代码一样：</p>
...
<h2 id="装饰者模式" tabindex="-1"><a class="header-anchor" href="#装饰者模式"><span>装饰者模式</span></a></h2>
<p>装饰者模式可以动态地给对象添加一些额外的属性或行为。相比于使用继承，装饰者模式更加灵活。简单点儿说就是当我们需要修改原有的功能，但我们又不愿直接去修改原有的代码时，设计一个 Decorator 套在原有代码外面。其实在 JDK 中就有很多地方用到了装饰者模式，比如 <code v-pre>InputStream</code>家族，<code v-pre>InputStream</code> 类下有 <code v-pre>FileInputStream</code> (读取文件)、<code v-pre>BufferedInputStream</code> (增加缓存,使读取文件速度大大提升)等子类都在不修改<code v-pre>InputStream</code> 代码的情况下扩展了它的功能。</p>
<figure><img src="https://oss.javaguide.cn/github/javaguide/Decorator.jpg" alt="装饰者模式示意图" tabindex="0"><figcaption>装饰者模式示意图</figcaption></figure>
...
<li>&lt;<a href="http://blog.yeamin.top/2018/03/27/%E5%8D%95%E4%BE%8B%E6%A8%A1%E5%BC%8F-Spring%20" target="_blank" rel="noopener noreferrer">http://blog.yeamin.top/2018/03/27/单例模式-Spring <ExternalLinkIcon/></a> 单例实现原理分析/&gt;</li>
