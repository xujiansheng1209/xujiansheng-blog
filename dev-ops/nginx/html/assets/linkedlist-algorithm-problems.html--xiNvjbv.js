import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as p,c as o,a as n,d as l,b as i,e as s}from"./app-Cg1ooxyK.js";const c={},u=s(`<h2 id="_1-两数相加" tabindex="-1"><a class="header-anchor" href="#_1-两数相加"><span>1. 两数相加</span></a></h2><h3 id="题目描述" tabindex="-1"><a class="header-anchor" href="#题目描述"><span>题目描述</span></a></h3><blockquote><p>Leetcode:给定两个非空链表来表示两个非负整数。位数按照逆序方式存储，它们的每个节点只存储单个数字。将两数相加返回一个新的链表。</p><p>你可以假设除了数字 0 之外，这两个数字都不会以零开头。</p></blockquote><p>示例：</p><div class="language-plain line-numbers-mode" data-ext="plain" data-title="plain"><pre class="language-plain"><code>输入：(2 -&gt; 4 -&gt; 3) + (5 -&gt; 6 -&gt; 4)
输出：7 -&gt; 0 -&gt; 8
原因：342 + 465 = 807
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Solution</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,57);function k(v,m){const a=t("ExternalLinkIcon");return p(),o("div",null,[u,n("p",null,[n("a",d,[l("https://leetcode-cn.com/problems/add-two-numbers/solution/"),i(a)])]),r])}const g=e(c,[["render",k],["__file","linkedlist-algorithm-problems.html.vue"]]),y=JSON.parse('{"path":"/cs-basics/data-structure/linkedlist-algorithm-problems.html","title":"几道常见的链表算法题","lang":"zh-CN","frontmatter":{"title":"几道常见的链表算法题","category":"计算机基础","tag":["算法"],"description":"1. 两数相加 题目描述 Leetcode:给定两个非空链表来表示两个非负整数。位数按照逆序方式存储，它们的每个节点只存储单个数字。将两数相加返回一个新的链表。 你可以假设除了数字 0 之外，这两个数字都不会以零开头。 示例： 问题分析 Leetcode 官方详细解答地址： https://leetcode-cn.com/problems/add-tw...","head":[["meta",{"property":"og:url","content":"https://snailcoding.cn/cs-basics/data-structure/linkedlist-algorithm-problems.html"}],["meta",{"property":"og:site_name","content":"蜗牛のJava宝典"}],["meta",{"property":"og:title","content":"几道常见的链表算法题"}],["meta",{"property":"og:description","content":"1. 两数相加 题目描述 Leetcode:给定两个非空链表来表示两个非负整数。位数按照逆序方式存储，它们的每个节点只存储单个数字。将两数相加返回一个新的链表。 你可以假设除了数字 0 之外，这两个数字都不会以零开头。 示例： 问题分析 Leetcode 官方详细解答地址： https://leetcode-cn.com/problems/add-tw..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://oss.javaguide.cn/github/javaguide/cs-basics/algorithms/34910956.jpg"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:alt","content":"几道常见的链表算法题"}],["meta",{"property":"article:author","content":"Mr.Xu"}],["meta",{"property":"article:tag","content":"算法"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"几道常见的链表算法题\\",\\"image\\":[\\"https://oss.javaguide.cn/github/javaguide/cs-basics/algorithms/34910956.jpg\\",\\"https://oss.javaguide.cn/github/javaguide/cs-basics/algorithms/81431871.jpg\\",\\"https://oss.javaguide.cn/github/javaguide/cs-basics/algorithms/94354387.jpg\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Mr.Xu\\",\\"url\\":\\"https://snailcoding.cn\\"}]}"]]},"headers":[{"level":2,"title":"1. 两数相加","slug":"_1-两数相加","link":"#_1-两数相加","children":[{"level":3,"title":"题目描述","slug":"题目描述","link":"#题目描述","children":[]},{"level":3,"title":"问题分析","slug":"问题分析","link":"#问题分析","children":[]},{"level":3,"title":"Solution","slug":"solution","link":"#solution","children":[]}]},{"level":2,"title":"2. 翻转链表","slug":"_2-翻转链表","link":"#_2-翻转链表","children":[{"level":3,"title":"题目描述","slug":"题目描述-1","link":"#题目描述-1","children":[]},{"level":3,"title":"问题分析","slug":"问题分析-1","link":"#问题分析-1","children":[]},{"level":3,"title":"Solution","slug":"solution-1","link":"#solution-1","children":[]}]},{"level":2,"title":"3. 链表中倒数第 k 个节点","slug":"_3-链表中倒数第-k-个节点","link":"#_3-链表中倒数第-k-个节点","children":[{"level":3,"title":"题目描述","slug":"题目描述-2","link":"#题目描述-2","children":[]},{"level":3,"title":"问题分析","slug":"问题分析-2","link":"#问题分析-2","children":[]},{"level":3,"title":"Solution","slug":"solution-2","link":"#solution-2","children":[]}]},{"level":2,"title":"4. 删除链表的倒数第 N 个节点","slug":"_4-删除链表的倒数第-n-个节点","link":"#_4-删除链表的倒数第-n-个节点","children":[{"level":3,"title":"问题分析","slug":"问题分析-3","link":"#问题分析-3","children":[]},{"level":3,"title":"Solution","slug":"solution-3","link":"#solution-3","children":[]}]},{"level":2,"title":"5. 合并两个排序的链表","slug":"_5-合并两个排序的链表","link":"#_5-合并两个排序的链表","children":[{"level":3,"title":"题目描述","slug":"题目描述-3","link":"#题目描述-3","children":[]},{"level":3,"title":"问题分析","slug":"问题分析-4","link":"#问题分析-4","children":[]},{"level":3,"title":"Solution","slug":"solution-4","link":"#solution-4","children":[]}]}],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"readingTime":{"minutes":7.2,"words":2159},"filePathRelative":"cs-basics/data-structure/linkedlist-algorithm-problems.md","excerpt":"<h2>1. 两数相加</h2>\\n<h3>题目描述</h3>\\n<blockquote>\\n<p>Leetcode:给定两个非空链表来表示两个非负整数。位数按照逆序方式存储，它们的每个节点只存储单个数字。将两数相加返回一个新的链表。</p>\\n<p>你可以假设除了数字 0 之外，这两个数字都不会以零开头。</p>\\n</blockquote>\\n<p>示例：</p>\\n<div class=\\"language-plain\\" data-ext=\\"plain\\" data-title=\\"plain\\"><pre class=\\"language-plain\\"><code>输入：(2 -&gt; 4 -&gt; 3) + (5 -&gt; 6 -&gt; 4)\\n输出：7 -&gt; 0 -&gt; 8\\n原因：342 + 465 = 807\\n</code></pre></div>","autoDesc":true}');export{g as comp,y as data};
